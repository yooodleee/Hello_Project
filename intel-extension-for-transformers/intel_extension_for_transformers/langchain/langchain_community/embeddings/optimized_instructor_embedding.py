...
class OptimizedInstructor(InstructorEmbedding.INSTRUCTOR):
    ...
    def _load_sbert_model(
        ...
        if config_sentence_transformers_json_path is not None:
            ...
            if '__version__' in self._model_config and \
                ...
                logger.warning(
                    ...
                    "latest version.\n\n\n".format(
                        self._model_config['__version']['sentence_transformers'],
        ...
        modules_json_path = sentence_transformers.util.load_fild_path(
            model_name_or_path,
            'modules.json',
            token=token,
            cache_folder=cache_folder,
        ...
        for module_config in modules_config:
            ...
            if module_class == sentence_transformers.models.Transformer and module_config['path'] == "":
                ...
                hub_kwargs = {
                    "token": token, "trust_remote_code": trust_remote_code, "revision": revision
                }
                ...
                module = OptimizedInstructorTransformer(
            ...
            elif module_class == sentence_transformers.modles.Normalize:
                module_path = None
                module = module_class.load(module_path)
